...
export default function StudentLeaderboardPage() {
  const { data, error, isLoading } = useSWR('/api/leaderboard?limit=100', fetcher)
    ...
    <div className="p-6 space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>Real exams only. Ranked by average score, then exams completed.</CardDescription>
        </CardHeader>
        <CardContent>
